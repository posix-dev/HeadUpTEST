...
import com.example.headuptest.common.calculateCalories
import com.example.headuptest.common.calculateCarbs
import com.example.headuptest.common.calculateFats
import com.example.headuptest.common.calculateProtein
            ...
            is Action.Init -> {
                viewModelScope.launch {
                    repository.getEntities().collect { diaryList ->
                        ...
                        val caloriesProgress: Double = params?.calculateCalories()?.let { allKcal / it } ?: 0.toDouble()
                        ...
                        state.update {
                            it.copy(
                                ...
                                calories = SummaryItem(
                                    "$allKcal/${params?.calculateCalories()?.roundToInt() ?: 0} KCAL",
